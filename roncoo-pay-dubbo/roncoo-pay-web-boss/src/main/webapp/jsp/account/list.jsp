...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${baseURL }/account/list"
		method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
				    <td>账户编号：
                        <input type="text" name="accountNo" value="${rpAccount.accountNo}" />
                    </td>
                    <td>
...
<div class="pageContent">
	<table class="table" width="101%" layoutH="85">
		<thead>
			<tr>
				<th width="5%">序号</th>
				<th width="15%">账户编号</th>
		...
		<tbody>
			<c:forEach var="item" items="${pageBean.recordList}" varStatus="s">
				<tr>
					...
					<td><fmt:formatDate value="${item.editTime}"
