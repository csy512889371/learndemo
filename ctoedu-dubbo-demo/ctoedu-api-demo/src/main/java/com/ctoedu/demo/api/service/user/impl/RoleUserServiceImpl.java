...
//import com.ctoedu.demo.api.service.user.RoleUserService;
...
//
//	@Override
//	public PageVO<RoleUserVO> getUser(String nickname, String username, String roleId, int number, int size, String currentUsername, List<String> currentUserRoleSn){
...
//			pageVO = getRoleUser(nickname, username, roleId, number, size);
//		}else if(currentUserRoleSn.contains(FayConstant.ORG_ADMIN_ROLE_SN)){
//			pageVO = getRoleUserByUnderOrgs(nickname, username, roleId, number, size, currentUsername);
//		}else{
...
//	}
//	
//	private PageVO<RoleUserVO> getRoleUser(String nickname, String username, String roleId, int number, int size){
...
//	}
//	
//	private PageVO<RoleUserVO> getRoleUserByUnderOrgs(String nickname, String username, String roleId, int number, int size, String currentUsername){
//		
//		List<String> userIds = userService.getUserIdsByLoginUser(currentUsername);
//		
//		Pageable page = new PageRequest(number, size);
//		Searchable searchable = Searchable.newSearchable();
//		searchable.setPage(page);
