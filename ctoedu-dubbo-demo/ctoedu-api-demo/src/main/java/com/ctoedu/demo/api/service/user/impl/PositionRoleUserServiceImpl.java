...
//import com.ctoedu.demo.api.service.user.PositionRoleUserService;
...
//
//@Service
//public class PositionRoleUserServiceImpl implements PositionRoleUserService {
//	
//	@Autowired
...
//
//	@Override
//	public PageVO<RoleUserVO> getUser(String nickname, String username, String positionId, String roleId, int number, int size, String currentUsername, List<String> currentUserRoleSn){
...
//			pageVO = getRoleUserWithUserIds(roleId, userService.getUserIdsByPosition(nickname, username, positionId), number, size);
//		}else{
