...
//import com.ctoedu.demo.api.service.user.GroupRoleUserService;
//import com.ctoedu.demo.api.service.user.UserService;
//import com.ctoedu.demo.facade.group.service.UmsGroupFacade;
//import com.ctoedu.demo.facade.role.entity.UmsUserRoleRelation;
//import com.ctoedu.demo.facade.role.service.UmsRoleFacade;
//
//@Service
//public class GroupRoleUserServiceImpl implements GroupRoleUserService {
//	
//	@Autowired
//	private UserService userService;
//	
//	@Reference
//	private UmsGroupFacade umsGroupFacade;
//	
//	@Reference
...
//
//	@Override
//	public PageVO<RoleUserVO> getUser(String nickname, String username, String groupId, String roleId, int number, int size, String currentUsername, List<String> currentUserRoleSn){
//		PageVO<RoleUserVO> pageVO = null;
//		if(Arrays.asList(FaySysRoleConstant.SUPER_MANAGE_USERNAME).contains(username) || roleService.validate(username, FaySysRoleConstant.SUPER_MANAGE_ROLE_SN) || currentUserRoleSn.contains(FayConstant.ORG_ADMIN_ROLE_SN)){
//			pageVO = getRoleUserWithUserIds(roleId, userService.getUserIdsByGroup(nickname, username, groupId), number, size);
//		}else{
